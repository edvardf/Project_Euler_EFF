...
num_grid = [[0 for _ in range(20)] for _ in range(20)]

i = 0
row, col = 0, 0

while i < len(num_str):
    num_grid[row][col] = (int(num_str[i:i+2]))
    i += 3
    col += 1
    if col % 20 == 0:
        col = 0
...
print("Greatest product of four adjacent numbers in the same direction (up, down, left, right, or diagonally) =",
      greatest_product_4_adj_num(num_grid))
